...
range   :   range1
        |   range intcOp range1
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.Intersect);
...
expr    :   expr EQ expr
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.EqualTo);
	      $$ = new ExpressionTree(ot, $1, $3);
            }
        |   expr GT expr
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.GreaterThan);
	      $$ = new ExpressionTree(ot, $1, $3);
            }
        |   expr LT expr
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.LessThan);
	      $$ = new ExpressionTree(ot, $1, $3);
            }
        |   expr GEQ expr
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.GreaterThanOrEqualTo);
	      $$ = new ExpressionTree(ot, $1, $3);
            }
        |   expr LEQ expr
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.LessThanOrEqualTo);
	      $$ = new ExpressionTree(ot, $1, $3);
            }
        |   expr NEQ expr
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.NotEqualTo);
	      $$ = new ExpressionTree(ot, $1, $3);
            }
        |   expr PLUS expr
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.Plus);
	      $$ = new ExpressionTree(ot, $1, $3);
            }
        |   expr MINUS expr
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.Minus);
	      $$ = new ExpressionTree(ot, $1, $3);
            }
        |   expr MULT expr
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.Multiply);
	      $$ = new ExpressionTree(ot, $1, $3);
            }
        |   expr DIV expr
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.Divide);
	      $$ = new ExpressionTree(ot, $1, $3);
            }
        |   expr PERCENT
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.Percent);
	      $$ = new ExpressionTree(ot, null, $1);
            }
        |   expr EXP expr
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.Exponentiate);
	      $$ = new ExpressionTree(ot, $1, $3);
            }
        |   MINUS expr %prec UMINUS
            {
	      OperatorToken ot =
		new OperatorToken(OperatorToken.Operator.Negate);
